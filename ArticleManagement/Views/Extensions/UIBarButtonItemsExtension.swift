//
//  UIBarButtonItemsExtension.swift
//  ArticleManagement
//
...
public extension UIViewController {
    ...
    func leftBackAction(_ action: @escaping ActionHandler) {
        self.leftBackBarButton(ArticleMNImageDI.back_icon.image, action: action)
    }
    
    //Back bar with go to previous action
    func leftBackToPrevious() {
        self.leftBackBarButton(ArticleMNImageDI.back_icon.image, action: nil)
    }
